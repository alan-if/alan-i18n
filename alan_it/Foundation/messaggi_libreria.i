...
The msg IsA location at limbo. Has
  ...
  ornamentale_P1_sg "$+1 non è importante ai fini del gioco.".
  ornamentale_P1_pl "$+1 non sono importanti ai fini del gioco.".
  ornamentale_P2_sg "$+2 non è importante ai fini del gioco.".
  ornamentale_P2_pl "$+2 non sono importanti ai fini del gioco.".
