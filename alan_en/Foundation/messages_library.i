...
-- tag::lib_msgs_def2[]
  scenery_response_P1_sg "Forget $+1, it's not important.".
  scenery_response_P1_pl "Forget $+1, they're not important.".
  scenery_response_P2_sg "Forget $+2, it's not important.".
  scenery_response_P2_pl "Forget $+2, they're not important.".
-- end::lib_msgs_def2[]
